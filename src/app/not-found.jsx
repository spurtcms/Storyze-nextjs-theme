        ...
        <>
            ...
            <div className=" px-5 lg:px-20  py-32 col-span-full grid place-items-center">
                <div className="flex flex-col items-center max-w-[642px] ">
                    <Image src="\img\404.svg" alt="nodata" className="dark:hidden" />
                    <Image
                        src="\img\404-dark.svg"
                        alt="nodata"
                        className="dark:block hidden"
                    />
                    <h1 className=" text-2xl leading-6 font-medium text-black dark:text-white  mb-3 mt-6 text-center">
                        Oops! This obviously isn&apos;t a page you were looking for.
                    </h1>
                    <p className=" text-base leading-6 font-normal text-[#555555] dark:text-white text-center dark:text-light-2 max-w-[480px]">
