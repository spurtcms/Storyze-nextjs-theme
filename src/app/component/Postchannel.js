...
return src
  ...
  const PostListdata=listdat?.channelEntriesList?.channelEntriesList.filter((response)=>response.channelId===data?.channelDetail?.id)
 ...
 <ChannelSkeleton/>
    ...
    <div className="grid grid-cols-1 sm:grid-cols-2 items-center gap-6">
          <div className="flex flex-col gap-4">
              ...
              <p className="text-gray-500 text-xl font-normal line-clamp-3 mb-3" dangerouslySetInnerHTML={{__html:data?.channelDetail.channelDescription}}>
                </p>
          </div>
    ...
    <>
          ...
          <div>
              ...
              <div>
                  ...
                  <p className="text-gray-500 text-lg font-light line-clamp-2 mb-3" dangerouslySetInnerHTML={{__html:response.description}}>
     ...
     {displayPosts < PostListdata.length?(
      <div className="flex justify-center">
          <button className="px-4 py-2 rounded-full text-white text-base font-medium bg-dark-grey" onClick={loadMore}>Load More</button>
      </div>
     ):""}
